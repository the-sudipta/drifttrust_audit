...
for(const p of ['index.html','lab.html','guide.html','site.css','site.mjs','lab.mjs','explanations.mjs','math-theatre.mjs','math-theatre.css'])fs.copyFileSync(p,`dist/client/${p}`);
fs.mkdirSync('dist/client/runtime',{recursive:true});
for(const p of ['math-trace.mjs','engine.mjs','browser-client.mjs','browser-worker.mjs'])fs.copyFileSync('runtime/'+p,'dist/client/runtime/'+p);
